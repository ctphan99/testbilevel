#!/usr/bin/env python3
"""
Comprehensive Convergence Test for F2CSA Algorithm 1
Ensures lower-level solution y converges accurately before moving to hyperparameter optimization
"""
...
class F2CSAConvergenceTest:
    ...
    def test_lower_level_convergence(self, alpha: float = 0.05, max_iterations: int = 1000):
        """
        Test lower-level solution convergence with more iterations
        """
        print("🔬 Testing Lower-Level Solution Convergence")
        print("=" * 60)
    ...
    def test_hypergradient_accuracy(self, alpha: float = 0.05):
        """
        Test hypergradient accuracy with converged lower-level solutions
        """
        print("🎯 Testing Hypergradient Accuracy")
        print("=" * 60)
    ...
    def test_algorithm_1_optimization(self, alpha: float = 0.05, max_iterations: int = 2000):
        """
        Test Algorithm 1 optimization with converged lower-level solutions
        """
        print("🚀 Testing Algorithm 1 Optimization")
        print("=" * 60)
        print(f"α = {alpha}, δ = {alpha**3:.6f}")
        print(f"Max iterations: {max_iterations}")
        print()
        
        # Generate initial point and run optimization
        x0 = torch.randn(self.dim, dtype=torch.float64)
        result = self.algorithm.optimize(x0, alpha=alpha, max_iterations=max_iterations)
    ...
    def run_comprehensive_test(self):
        ...
        """
        print("🎯 F2CSA Algorithm 1 Comprehensive Convergence Test")
        print("=" * 70)
        ...
        print("=" * 50)
        convergence_results = self.test_lower_level_convergence(alpha=0.05, max_iterations=1000)
        
        # Test 2: Hypergradient accuracy
        print("🎯 PHASE 2: Hypergradient Accuracy")
        print("=" * 50)
        hypergradient_results = self.test_hypergradient_accuracy(alpha=0.05)
        
        # Test 3: Algorithm 1 optimization
        print("🚀 PHASE 3: Algorithm 1 Optimization")
        print("=" * 50)
        optimization_result = self.test_algorithm_1_optimization(alpha=0.05, max_iterations=2000)
        ...
        return {
            ...
            'hypergradient_results': hypergradient_results,
            'optimization_result': optimization_result
        }

def main():
    """Main test function"""
    test = F2CSAConvergenceTest()
